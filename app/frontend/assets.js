...
module.exports = {
    ...
    components: concat([
        ...
        './calendar/timeline/timeline-week-marker.js',
        './calendar/timeline/timeline-week.js',
        './calendar/search/day-selection.js',
        './calendar/layout.js',
        './calendar/resource-renderer.js',
        './calendar/calendar-event.js',
        './calendar/calendar-event-week.js',
        './calendar/calendar.js',
        './calendar/calendar-week.js',
        './calendar/event-creation.js',
        './calendar/page-calendar-day.js',
        './calendar/page-calendar-week.js',
